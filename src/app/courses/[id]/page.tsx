...
export default function CourseDetailPage({ params }: DetailPageProps) {
  ...
  const course = courses.find((c) => c.uniqueId === id);
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>The course may not be loaded yet or the identifier is invalid.</CardDescription>
          </CardHeader>
        </Card>
      </div>
    );
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <DetailItem icon={<Calendar />} label="Int'l Deadline" value={formatDate(course.internationalApplicationDeadline)} />
                <DetailItem icon={<Calendar />} label="Domestic Deadline" value={formatDate(course.domesticApplicationDeadline)} />
                <Button asChild className="w-full mt-4 bg-accent hover:bg-accent/90 text-accent-foreground">
                  <Link href={course.courseUrl || university?.officialWebsite || '#'} target="_blank">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <DetailItem icon={<Target />} label="IELTS Score" value={course.minimumIELTSScore ? `Minimum ${course.minimumIELTSScore}` : 'Not specified'} />
